...
### 🌤️ [Weather Hub — прогноз погоды](https://zhitnikov.github.io/weather/dist/)
Современное SPA-приложение для просмотра погоды с интеграцией OpenWeather API.  
Поддержка геолокации, поиск по городам, смена темы и единиц измерения.  
**Стек:** React, TypeScript, Vite, SCSS.  
☁️ *i18n, самописные хуки, адаптивный дизайн, стиль glassmorphism.*
---
...
- ⚙️ **HTML5 / CSS3 / SCSS / JavaScript (ES6+) / TypeScript**
